  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Accent colors - soft teal/emerald
        'accent': {
          teal: '#2dd4bf',
          emerald: '#34d399',
          cyan: '#67e8f9',
      ...
      backgroundImage: {
        ...
        'gradient-glow': 'radial-gradient(ellipse at center, rgba(45, 212, 191, 0.1) 0%, transparent 70%)',
      ...
      keyframes: {
        ...
        'pulse-glow': {
          '0%, 100%': { opacity: '1', boxShadow: '0 0 20px rgba(45, 212, 191, 0.15)' },
          '50%': { opacity: '0.8', boxShadow: '0 0 40px rgba(45, 212, 191, 0.25)' },
        },
        'slide-up': {
